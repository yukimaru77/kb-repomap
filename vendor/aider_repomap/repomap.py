# Extracted from Aider-AI/aider, Apache-2.0. Modified for standalone use.
# See PROVENANCE.md for the pinned commit and modifications.
import math
...
class RepoMap:
    ...
    def __init__(
        ...
        if cache_dir is not None:
            self.TAGS_CACHE_DIR = str(Path(cache_dir).resolve())
    ...
    def get_tags_raw(self, fname, rel_fname):
        ...
        try:
            ...
            self.io.tool_warning(f"Skipping file {fname}: {err}")
            return
